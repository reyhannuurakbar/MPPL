...
class RestaurantPackageController extends Controller
{
    ...
    {
       //$restaurant_package = RestaurantPackage::all();
    ...
    {
        $data = $request->all();
        $data['slug'] = Str::slug($request->title); //panggil slug
        $data['image'] = $request->file('image')->store('assets/gallery', 'public');//menyimpan gambar di publik directory
